...
parser.add_argument("--data_path",type=str, default="./rain100L/test/small/rain",help='path to testing rainy images a and b for latent space interpolation')
parser.add_argument("--gt_path",type=str, default="./rain100L/test/small/norain",help='path to testing gt images')
...
parser.add_argument('--netEG', default='./syn100lmodels/EG_state_190.pt', help="path to trained generator")
